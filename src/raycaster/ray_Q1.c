...
/*   Updated: 2023/09/05 18:02:04 by cgodecke         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
double ray_Q1(t_data *data, int *i, int *j, int *wall)
{
	...
	{
		data->ray_x = data->player_x + fabs(1.0*ray_y_length * cos(deg_to_rad(data->ray_angle)));
		data->ray_y = data->player_y - fabs(1.0 * ray_y_length * sin(deg_to_rad(data->ray_angle)));
		*wall = map[(int)floor(data->ray_y)][(int)floor(data->ray_x)];
