...
/*   Updated: 2023/09/05 18:18:20 by cgodecke         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
double ray_Q4(t_data *data, int *i, int *j, int *wall)
{
	...
	ray_x_length = 1.0000001*ray_x_sx_start + *i * fabs(unit_ray_x_length(data));
	ray_y_length = 1.0000001*ray_y_sy_start + *j * fabs(unit_ray_y_length(data));
