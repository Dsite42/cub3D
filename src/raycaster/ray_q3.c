...
/*   Updated: 2023/10/04 09:37:31 by cgodecke         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	return (ceil(data->player_y) - data->player_y);
}
		...
		int *j, int *wall)
{
	...
	*wall = data->map_flood[(int)floor(data->ray_y)][(int)floor(data->ray_x)]
		- '0';
